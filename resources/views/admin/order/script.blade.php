        ...
        var table = function(){
            var t = $('#table').DataTable({
                ...
                'columns': [
                    ...
                    { data: 'invoice', name: 'invoice', class: 'text-left', orderable: false, searchable: false },
                    { data: 'paket.nama_paket', name: 'paket.nama_paket', class: 'text-left' },
                    { data: 'user.name', name: 'user.name', class: 'text-left' },
                    { data: 'status_format', name: 'status_format', class: 'text-left' },
